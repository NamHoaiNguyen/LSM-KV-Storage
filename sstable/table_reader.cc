...
//       read_file_object_(std::make_uniqu<io::LinuxReadOnlyFile>(filename_)) {}
...
//   ssize_t bytes_read =
//       read_file_object_->RandomRead(extra_info_buffer,
//       start_offset_extra_info);
//   if (bytes_read < 0) {
//     return;
//   }

//   // first 8 bytes contains info of total block entries in table
//   *total_block_entries = *reinterpret_cast<uint64_t
//   *>(&extra_info_buffer[0]);
//   // byte 8 - 15 contains starting offset of meta section
//   *starting_meta_section_offset =
//       *reinterpret_cast<uint64_t *>(&extra_info_buffer[8]);
//   // byte 16 - 23 contains length of meta section
//   *meta_section_length = *reinterpret_cast<uint64_t
//   *>(&extra_info_buffer[16]);
//   // byte 24- 31 contains min transaction id
//   min_transaction_id_ = *reinterpret_cast<uint64_t
//   *>(&extra_info_buffer[24]);
//   // byte 32 - 40 contain max transcation id
//   max_transaction_id_ = *reinterpret_cast<uint64_t
//   *>(&extra_info_buffer[32]);
// }
